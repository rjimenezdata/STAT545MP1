...
-   SLO seems to be driest overall.
-   Marin experiences more light and heavy rain.
-   San Diego has very low heavy rain, but high missingness in data
...
-   Marin has most cold days (further north)

-   SLO has balanced mix between temperature grouping

-   San Diego has the highest comfortable percentage
...
-   San Diego has an extremely long return time for heavy rain

-   Marin has more frequent transitions to rainy states

-   No rain state is highly persistent for all locations
...
-   Strong day-today stability in temperature for all.
...
-   Temperature persistence occurs once again

-   In Summer hot to hot persistence is extremely high, while most other states have higher transition to the state +1 in heat.

-   In winter, almost all have high persistence.
